...
for s = 1, screen.count() do
    ...
    tags[s] = awful.tag({ 1, 2 }, s, layouts[3])
end
-- }}}
...
batterywidgettimer:connect_signal("timeout",
  function()
    ...
    fi = assert(io.popen("date +'%a %b %d, %I:%M'", "r"))
    batterywidget:set_text(" | " .. fi:read("*l") .. " |" .. fh:read("*l") .. " | ")
    fh:close()
    fi:close()
  end
)
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey,           }, "x", function () awful.util.spawn_with_shell("synclient|grep TouchpadOff|awk -F=\  '{if($2==1) print \"synclient TouchpadOff=0\"; else  print \"synclient TouchpadOff=1\";}'|sh") end),
